...
class AcumuladoresCteEntradaForm extends Component implements HasForms
{
    ...
    public function mount(): void
    {
        ...
        $acumuladores = $config->obterAcumuladoresCteEntrada();
    ...
    public function save(): void
    {
        ...
        $config = ConfiguracaoFactory::atual();
        $config->salvarAcumuladoresCteEntrada($formData);

        Notification::make()
            ->success()
            ->title('Acumuladores de CTe de entrada salvos com sucesso')
            ->send();
    }

    public function render()
    {
        return view('filament.fiscal.pages.configuracoes.acumuladores-cte-entrada-form');
    }
}
