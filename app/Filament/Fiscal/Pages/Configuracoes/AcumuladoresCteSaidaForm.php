...
class AcumuladoresCteSaidaForm extends Component implements HasForms
{
    ...
    public function mount(): void
    {
        ...
        $acumuladores = $config->obterAcumuladoresCteSaida();
    ...
    public function save(): void
    {
        ...
        $config = ConfiguracaoFactory::atual();
        $config->salvarAcumuladoresCteSaida($formData);

        Notification::make()
            ->success()
            ->title('Acumuladores de CTe de saída salvos com sucesso')
            ->send();
    }

    public function render()
    {
        return view('filament.fiscal.pages.configuracoes.acumuladores-cte-saida-form');
    }
}
