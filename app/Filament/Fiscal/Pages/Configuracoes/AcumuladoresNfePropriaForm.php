...
class AcumuladoresNfePropriaForm extends Component implements HasForms
{
    ...
    public function mount(): void
    {
        ...
        $acumuladores = $config->obterAcumuladoresNfePropria();
    ...
    public function save(): void
    {
        ...
        $config = ConfiguracaoFactory::atual();
        $config->salvarAcumuladoresNfePropria($formData);

        Notification::make()
            ->success()
            ->title('Acumuladores de NFe própria salvos com sucesso')
            ->send();
    }

    public function render()
    {
        return view('filament.fiscal.pages.configuracoes.acumuladores-nfe-propria-form');
    }
}
