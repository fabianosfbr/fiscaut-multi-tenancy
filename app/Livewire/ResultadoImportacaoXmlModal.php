...
class ResultadoImportacaoXmlModal extends Component
{
    ...
    {
        $this->resultados = $data; // Armazena os dados recebidos na propriedade $modalData
        $this->showModal = true;
    ...
    {
        return view('livewire.resultado-importacao-xml-modal');
    }
}
